...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || DigiStock</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">DigiStock Shop</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; DigiStock. All Rights Reserved.</p>
        </footer>
